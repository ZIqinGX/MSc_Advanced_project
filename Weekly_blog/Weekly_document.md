...
**Object** The object I want to achieve is try to train a model which can capture the change of hand （by camera） and mapping the change into rythm (such as position of hand ,one simple way is read the coordinate of hand. If the position of 
